ProjectApp.directive("podPieChart", function ($timeout, Translator) {
    return {
        restrict: 'E',
        ...
        link: function ($scope, element) {
            let option = {
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: [Translator.get("i18n_running"), Translator.get("i18n_not_running")]
                },
                title: {
                    text: $scope.setting.count + '\r\n' + Translator.get("i18n_module"),
                    x: 'center',
                    y: 'center',
                    textStyle: {
                        fontWeight: 'normal',
                ...
                tooltip: {
                    ...
                    formatter: function (params) {
                        ...
                        if (params.dataIndex === 0) {
                            html = html + Translator.get("i18n_running") + '：' + $scope.setting.rmoduleList.length;
                            html = "<table>" + html;
                            ...
                            html = html + Translator.get("i18n_not_running") + '：' + $scope.setting.smoduleList.length;
                            html = "<table>" + html;
                ...
                series: [
                    {
                        ...
                        data: [
                            {value: $scope.setting.rmoduleList.length, name: Translator.get("i18n_running")},
                            {value: $scope.setting.smoduleList.length, name: Translator.get("i18n_not_running")}
                        ]
                    }
                ]
            };
