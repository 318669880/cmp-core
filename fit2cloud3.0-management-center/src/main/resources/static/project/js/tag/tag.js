ProjectApp.controller('TagController', function ($scope, $mdDialog, $document, $state, $stateParams, HttpUtils, FilterSearch, Notification, AuthService, $filter) {
    ...
    $scope.editTagForm = function (item) {
        $scope.item = item;
        $scope.formUrl = 'project/html/tag/tag-edit.html' + '?_t=' + window.appversion;
        $scope.toggleForm();
    };
    ...
    $scope.editValues = function (item) {
        $state.go("tag-values-edit", {tag: item, tagParam: {pagination: $scope.pagination, filters: $scope.filters}});
    };
...
ProjectApp.controller('TagValuesController', function ($scope, $mdDialog, $state, $stateParams, $document, HttpUtils, FilterSearch, Notification, AuthService, $filter) {
    ...
    $scope.editTagValueForm = function (item) {
        ...
        $scope.item = item.id ? item : {tagKey: $scope.tag.tagKey};
        $scope.formUrl = 'project/html/tag/tag-value-edit.html' + '?_t=' + window.appversion;
        $scope.toggleForm();
    };
    ...
    $scope.import = function () {
        $scope.formUrl = 'project/html/tag/tag-value-import.html' + '?_t=' + Math.random();
        $scope.toggleForm();
    };
